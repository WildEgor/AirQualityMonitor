...
Settings::Settings() 
    : LoopTickerBase(), _wifi_conn(nullptr), _mqtt_conn(nullptr), _sensors(nullptr), _needs_init(true) {}

void Settings::setup(SettingsDB& dbWrapper, WiFiConn& wifiWrapper, MQTTConn& mqttWrapper, SensorContainer& sensorsWrapper) {
